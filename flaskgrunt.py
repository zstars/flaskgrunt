import os
from flask import Flask, current_app, render_template_string, send_file, render_template
from werkzeug.exceptions import NotFound

app = Flask(__name__)

app.config["DEBUG"] = True
app.config["FLASK_YEOMAN_DEBUG"] = False

# def serve_for_dev(path):
#     root_path = os.path.join(current_app.root_path, "ngapps/myapp")
#
#     default_path = os.path.join(root_path, "app")
#
...
def serve_index(path):
    ...
    if path == "index.html":
        if flask_yeoman_debug:
            ...
            return render_template("__dist_appindex.html")
